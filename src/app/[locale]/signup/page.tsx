  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        ...
        // Wait for session propagation and redirect
        setTimeout(() => {
          router.push(`/${locale}`);
        }, 1000);
      }
      ...
      if (!isVerificationSent) { // Only stop loading if we aren't showing the verification view (which stops it itself)
        setIsLoading(false);
      }
    }
  };
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 text-center">
            ...
            <div className="space-y-4">
              ...
              <Link
                href={`/${locale}/login`}
                className="block w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-green hover:bg-brand-green/90 focus:outline-none"
              >
                Return to Login
              </Link>
            </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="bg-brand-green/10 border border-brand-green/20 rounded-lg p-4 mb-4">
              <p className="text-sm text-gray-700">
                ...
                <Link href={`/${locale}/become-tasker`} className="text-brand-green hover:text-brand-green/80 font-medium underline">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`pl-10 w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-brand-green focus:border-brand-green ${errors.location ? 'border-red-300' : 'border-gray-300'
                    }`}
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="agreeToTerms" className="text-gray-700">
                    I agree to the{' '}
                    <Link href={`/${locale}/terms`} className="text-brand-green hover:text-brand-green/80">
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link href={`/${locale}/privacy`} className="text-brand-green hover:text-brand-green/80">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
