                ...
                {offers.map((offer: Offer) => (
                    <div key={offer.id} className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 hover:border-brand-green/30 transition-colors">
                        ...
                        <div className="flex justify-end gap-3">
                            <button className="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-green">
                                Message
                            </button>
                            <button className="px-4 py-2 bg-brand-green text-white rounded-md text-sm font-medium hover:bg-brand-green/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-green">
                                Accept Bid
                            </button>
                        </div>
                    </div>
