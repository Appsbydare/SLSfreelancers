  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'hover-glow': 'hover-glow 0.3s ease-out',
        'hover-shake': 'hover-shake 0.5s ease-out',
        ...
        'stagger-4': 'stagger-4 0.6s ease-out 0.4s both',
        'stagger-5': 'stagger-5 0.6s ease-out 0.5s both',
      },
      keyframes: {
        'fade-in': {
          '0%': { opacity: '0' },
